...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const NEPTUNE_COLORS: ColorRGB[] = [
      { r: 0.58, g: 0.27, b: 0.95 }, // purple
      { r: 0.91, g: 0.33, b: 0.78 }, // fuchsia
      { r: 0.35, g: 0.56, b: 0.98 }, // blue
    ]

    function generateColor(): ColorRGB {
      const base = NEPTUNE_COLORS[
        Math.floor(Math.random() * NEPTUNE_COLORS.length)
      ]
