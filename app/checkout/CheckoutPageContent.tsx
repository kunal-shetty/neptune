      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-gray-50">
        <div className="bg-white shadow-lg rounded-2xl p-10 max-w-lg w-full">
          <div className="flex justify-center mb-4">
            <div className="w-14 h-14 bg-red-100 text-red-600 flex items-center justify-center rounded-full">⚠️</div>
          </div>

          <h2 className="text-2xl font-bold text-gray-900 mb-2">Invalid Checkout Link</h2>

          <p className="text-gray-600 mb-6 text-lg">
            We couldn't verify your plan details. This link may have expired or been modified.
          </p>
  ...
  const startPayment = async () => {
    ...
    const options = {
      ...
      handler: async (response: any) => {
        ...
        localStorage.setItem("nc_payment", JSON.stringify({ hasPaid: true, plan }))
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4">
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-xl p-4">
        <h1 className="text-3xl font-bold mb-2 text-gray-900 text-center">Checkout</h1>
        <p className="text-gray-600 text-center mb-8">Complete your purchase to unlock premium AI features.</p>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">Payments are securely processed via Razorpay.</p>
      </div>
    </div>
  )
}
